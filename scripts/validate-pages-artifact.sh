...
need_file "$public_dir/assets/images/webui/now.png"
need_file "$public_dir/assets/images/webui/album.png"
need_file "$public_dir/docs/index.html"
need_file "$public_dir/docs/get-started.html"
need_file "$public_dir/docs/webui.html"
need_file "$public_dir/docs/remix.html"
...
need_file "$public_dir/zh/docs/webui.html"
need_file "$public_dir/zh/docs/remix.html"
